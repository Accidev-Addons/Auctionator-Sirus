...
function AuctionatorFullScanFrameMixin:RegisterForEvents()
  ...
  FrameUtil.RegisterFrameForCustomEvents(self, FULL_SCAN_CUSTOM_EVENTS)
end
...
function AuctionatorFullScanFrameMixin:UnregisterForEvents()
  ...
  FrameUtil.UnregisterFrameForCustomEvents(self, FULL_SCAN_CUSTOM_EVENTS)
end
